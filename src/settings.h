...
// If extra information should be logged
#define VERBOSE // General verbose logging about protogen state
// #define VERBOSE_TICK_TIME // Log time taken to run the tick function
